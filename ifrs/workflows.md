...
1. **Estimates** — IFRS estimates at the date of transition must be consistent with estimates made at that date under previous GAAP (unless there is objective evidence those estimates were in error). Hindsight may not be used.
2. **Derecognition of financial assets and financial liabilities** — apply derecognition requirements prospectively from the date of transition (do not reinstate financial assets or liabilities derecognised under previous GAAP before the date of transition, except for items derecognised after 1 January 2004 that would qualify for recognition under IFRS 9).
3. **Hedge accounting** — do not retrospectively apply hedge accounting to relationships that did not qualify under previous GAAP. If hedge accounting was applied under previous GAAP, reassess whether the hedge qualifies under IFRS 9 at the date of transition.
4. **Classification and measurement of financial assets** — assess the business model (hold to collect, hold to collect and sell, or other) based on facts and circumstances at the date of transition.
...
### Step 4: Consider Optional Exemptions (IFRS 1.C1-D39, Appendices C-D)

The entity **may elect** to use any of the following exemptions (key exemptions listed):

| Exemption | Effect |
|---|---|
| **Business combinations** (IFRS 1.C1-C7) | Need not restate business combinations before the date of transition; carry forward previous GAAP amounts for goodwill (subject to impairment test) |
| **Deemed cost for PP&E, investment property, intangible assets** (IFRS 1.D5-D8B) | Use fair value at the date of transition as deemed cost, or use a previous GAAP revaluation as deemed cost if broadly comparable to fair value or cost under IFRS |
| **Cumulative translation differences** (IFRS 1.D12-D13) | Deem cumulative translation differences for all foreign operations to be zero at the date of transition; recycle gain or loss on subsequent disposal based only on post-transition amounts |
| **Borrowing costs** (IFRS 1.D23) | Apply IAS 23 prospectively from the date of transition (or an earlier date elected by the entity); no need to capitalise borrowing costs for qualifying assets before the date of transition |
| **Lease arrangements** (IFRS 1.D9-D9E) | Use transitional provisions similar to those in IFRS 16 at the date of transition (e.g., measure lease liabilities at PV of remaining payments; ROU asset equal to the lease liability, adjusted for prepayments/accruals) |
| **Share-based payments** (IFRS 1.D2-D3) | Encouraged but not required to apply IFRS 2 to equity instruments granted on or before 7 November 2002, or those that vested before the date of transition |
...
### Step 5: Prepare Reconciliations (IFRS 1.24-28)

The first IFRS financial statements must include reconciliations from previous GAAP to IFRS for:

1. **Equity** at the date of transition and at the end of the last period reported under previous GAAP.
2. **Total comprehensive income** (or separately, profit or loss) for the last period reported under previous GAAP.
3. If the entity recognised or reversed any **impairment losses** for the first time in preparing the opening IFRS balance sheet, disclose those amounts.

#### Reconciliation Template — Equity:

```
| Line Item                          | Previous GAAP   | IFRS Adj.   | Ref. | IFRS          |
|                                    | (Date of Trans.)| (Dr) / Cr   |      | (Date of Trans.)|
|------------------------------------|-----------------|-------------|------|----------------|
| Property, plant & equipment        |   XXX           |  (XX) / XX  | (a)  |   XXX          |
| Right-of-use assets                |   —             |  XX         | (b)  |   XXX          |
| Intangible assets                  |   XXX           |  (XX)       | (c)  |   XXX          |
| Financial assets                   |   XXX           |  (XX) / XX  | (d)  |   XXX          |
| Deferred tax assets                |   XXX           |  XX         | (e)  |   XXX          |
| Other assets                       |   XXX           |  —          |      |   XXX          |
| TOTAL ASSETS                       |   X,XXX         |  XX         |      |   X,XXX        |
|                                    |                 |             |      |                |
| Lease liabilities                  |   —             |  XX         | (b)  |   XXX          |
| Provisions                         |   XXX           |  XX         | (f)  |   XXX          |
| Financial liabilities              |   XXX           |  (XX) / XX  | (d)  |   XXX          |
| Deferred tax liabilities           |   XXX           |  XX         | (e)  |   XXX          |
| Other liabilities                  |   XXX           |  —          |      |   XXX          |
| TOTAL LIABILITIES                  |   X,XXX         |  XX         |      |   X,XXX        |
|                                    |                 |             |      |                |
| Share capital                      |   XXX           |  —          |      |   XXX          |
| Retained earnings                  |   XXX           |  (XX) / XX  | (g)  |   XXX          |
| Other reserves                     |   XXX           |  (XX) / XX  |      |   XXX          |
| TOTAL EQUITY                       |   X,XXX         |  (XX) / XX  |      |   X,XXX        |
```
...
1. **An explicit and unreserved statement of compliance with IFRS** (IAS 1.16).
2. **Reconciliations** (as described in Step 5).
3. **Explanation of material adjustments** to the statement of financial position, statement of comprehensive income, and (if presented) statement of cash flows.
4. If the entity recognised or reversed any impairment losses during the transition, disclose:
   - The nature and amount of impairment losses recognised or reversed.
5. **Accounting policies** applied in the opening IFRS balance sheet and any changes during periods covered by the first IFRS financial statements.
6. If the entity used **deemed cost** exemptions:
   - The aggregate of those deemed costs.
   - Whether the entity used fair values or previous GAAP revaluation as deemed cost.
...
*End of workflows document. Each workflow is designed to be followed sequentially, with decision points guiding the practitioner to the correct accounting treatment under IFRS.*
